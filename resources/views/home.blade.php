...
<head>
  ...
  <div class="container-fluid">
    <a class="navbar-brand" href="/"><h1>Works <img src="https://cdn-icons-png.flaticon.com/512/1599/1599904.png" alt="" id="incon"></h1 ></a>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="/vagasemprego">Crie novas vagas de emprego</a>
        </li>
...
<div class="card-body">
    ...
    <h6 class="card-subtitle mb-2 text-muted">Renumeracão:R${{$vaga -> renumeracao}}</h6>
...
@endforeach
@else <p id="aviso">Nenhuma vaga no momento</p>
@endif
</body>
<footer>
  <p>alisson.monteiro@escolar.ifrn.edu.br</p>
